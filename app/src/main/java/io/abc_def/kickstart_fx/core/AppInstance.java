...
public class AppInstance {
    ...
    //        if (client.isEmpty()) {
    //            // If an instance is running as another user, we cannot connect to it as the xpipe_auth file is
    // inaccessible
    ...
    //            TrackEvent.info(
    //                    "Another instance is already running on this port as another user or is not reachable.
    // Quitting ...");
    //            AppOperationMode.halt(1);
    //            return;
    //        }
