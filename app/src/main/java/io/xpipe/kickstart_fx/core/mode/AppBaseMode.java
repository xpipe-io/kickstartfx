...
import io.xpipe.kickstart_fx.update.UpdateAvailableDialog;
import io.xpipe.kickstart_fx.util.GlobalTimer;
import io.xpipe.kickstart_fx.util.WindowsRegistry;
