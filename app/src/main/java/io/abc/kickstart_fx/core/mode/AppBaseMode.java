...
import io.abc.kickstart_fx.core.check.*;
import io.abc.kickstart_fx.core.window.AppDialog;
import io.abc.kickstart_fx.core.window.AppMainWindow;
import io.abc.kickstart_fx.core.window.AppWindowTitle;
...
import io.abc.kickstart_fx.update.UpdateAvailableDialog;
import io.abc.kickstart_fx.util.GlobalTimer;
import io.abc.kickstart_fx.util.WindowsRegistry;
